...
export default function Nav() {
  ...
  return (
        <header className="
                sticky top-0 z-30 border-b border-zinc-200/70
                dark:border-zinc-800/70 bg-white/70
                dark:bg-zinc-950/60 backdrop-blur"
        >
                ...
                <div className="hidden md:flex items-center gap-4 text-zinc-900 dark:text-zinc-100">
                    ...
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="
                                ring-focus w-72 rounded-xl border border-zinc-200/70
                                dark:border-zinc-800/70 bg-transparent pl-9 pr-3 py-2
